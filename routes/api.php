...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::resource('orders-tracking', App\Http\Controllers\API\OrderTrackingController::class);
    Route::get('orders-tracking/order/{id}', [App\Http\Controllers\API\OrderTrackingController::class, 'indexByOrderId']);
